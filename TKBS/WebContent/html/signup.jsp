...
<jsp:include page="header1.jsp" />
	...
	<section style="margin: 0 auto; width: 40%;">
		...
		<form class="form-horizontal" method="post" action="/TKBS/RegisterUser" id="signup">
			...
			<br/>
			<div class="form-inline">
				<label class="radio-inline col-sm-6"> <input type="radio"
					id="inlineRadio1" value="User" name="type"> Student
				</label> 
				<label class="radio-inline col-sm-6"> <input type="radio"
					id="inlineRadio2" value="Expert Attorney" name="type" required> Expert Attorney
				</label>
				<!--div><label class="radio-inline col-sm-4"> <input type="radio"
					id="inlineRadio3" value="Admin" name="type"> Data Admin
				</label>
				<div-->
			</div>
			<br/>
			...
			<div class="form-inline">
			<div class="col-sm-3">
					<a href="index.jsp" class="btn btn-primary" name="temp" style="background-color:white; border-color:black; color:black;">Back</a>
			</div>
			<div class="col-sm-3">
				<a href="index.jsp" class="btn btn-primary" name="temp" style="background-color:white; border-color:black; color:grey;">Home</a>
			</div>
				<div class="col-sm-3">
