...
<%session.setAttribute("logid","1"); %>
	...
	<section style="margin: 0 auto; width: 20%;margin-top: 80px;">
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
                    ...
                    <p align="justify">Entered Credentials are not Valid</p>
	...
	<div class="form-inline" style="margin-left:480px; " >
				...
				<div class="col-sm-3">
					...
					<button type="submit" class="btn btn-primary" name="" style="color:grey;" >Back</button>
				</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-primary" name="signUp" style="color:grey;">Home</button>
				</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-primary" name="signUp" style="color:grey;">Submit</button>
				</div>
				</div>
				</form>
