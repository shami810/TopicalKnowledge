...
String QueryString = "SELECT * from doctrinerule where doctrineType = 'Doctrine'";
rs = statement.executeQuery(QueryString);
%>
<h5><center>Policy Report</center></h5>
<br/>
<br/>
...
<div class="form-inline" style="margin-left:480px; " >
			...
			<div class="col-sm-3">
					<a href="/TKBS/html/user/ruleReport.jsp" class="btn btn-primary" name="temp" style="background-color:white; border-color:black; color:black; ">Next</a>
			</div>	
			</div>
				</form>
